...
2019年度、再スタートを切った当法人は開発体制の拡充に取り組んだ。まず開発イベントを開催し、そこでコントリビュータになり得るエンジニアを集め、ついで月次で開発者会議を開催し、コントリビュータと開発方針を討議決定するといった体制である。そうした中で立ち上がってきたのが、以下のようなVivliostyle Pubの構想だった。

- 概要
    - ブラウザから操作するWebアプリ
    - クラウドにVivliostyle CLIをおき、ユーザコンテンツはGitHubで管理する
    - ユーザがGitHubを意識する必要はないが、GitHubアカウントはログインのために用意してもらう
- ターゲットユーザ
...
![開発に当たって共有されたVivliostyle Pubの動作メモ]](./fig-1.png)

こうして残された課題は、Vivliostyle Pubの開発を支える資金の確保となり、これが2020年度の課題となった。
