...
このように多くの時間と労力を費やして応募した未踏アドバンスト事業だが、残念ながら6月10日に落選通知を受け取ることとなった。以下が主催する情報処理推進機構（IPA）からいただいた落選理由である。
...
[前期の事業報告書](https://connpass.com/event/141767/)で触れたように、当法人の創設以来、た公式サイトのデザインは2年あまり変わらないままだった。これを一新するべく、開発者会議で討議を重ねて以下のような方針を定め、2018年12月から[yamasy1549](https://github.com/yamasy1549)氏にお願いして作業にとりかかった。
...
- ユーザーの利便性のため、以下のページを新設
    - プロダクトの概要をまとめた「使ってみる」
    - ユーザガイドやチュートリアルガイド等の開発用ドキュメント
    - 疑問を解決するFAQ

前述したように開発者／ユーザイベントの準備も平行して行わなければならなかったため、作業は難航を極めたが、なんとかイベント直前の4月3日にリニューアルすることができた。その後も、以下のような情報を追加していった。
...
中でも寄付による支援を呼びかけは、営利を目的としない（利益の分配をしない）一般社団法人として重要なものだ。今期は全部で61,209円の寄付金を集めることができた。これは経常収益全体の約4%にあたる（図3）。当法人の活動に賛同してくれる方々の受け皿として、寄付金は大事に育てていかねばならないと考えている。
