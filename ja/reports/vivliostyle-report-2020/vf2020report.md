...
開発と平行して難解な応募書類の作成に取り組み、4月2日に応募を完了。5月15日にはぶじに1次予選を通過する。翌16日、いよいよ村上代表理事を含むコントリビュータ達は2次審査に臨んだ。以下はこのときプレゼンテーションしたスライド資料だ。
...
前述したように開発者／ユーザイベントの準備も平行して行わなければならなかったため、作業は難航したが、なんとかイベント直前の4月3日にリニューアルさせることができた。その後も、以下のような情報を追加していった。
