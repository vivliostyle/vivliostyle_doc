...
しかし、その後も感染状況は激化する一方だった。他は中止しているのに自分たちだけ開催して大丈夫か、万が一感染者が出たらどうするのか？　まさに五里霧中である。悩んだ挙げ句に、やはり開催すると決断する。背中を押したのは、いったん状況に流されてしまえば、Vivliostyleも飲み込まれて消えてしまうという危機感だった。こういう時は意地でも旗を振るべきだ。そうして発表したのが、3月21日付ブログである。
...
前掲図1を見返していただくと一目瞭然だが、株価は3月後半に底を打ち、その後は上昇に転じる。11月には下落以前の株価を回復しただけでなく、変わらず上昇を続けている。少なくとも世界恐慌は杞憂に終わった。ただし、IT・メディア系などの業界が巣ごもり需要／テレワーク需要を追い風にできた一方で[^7]、百貨店、アパレル、外食や小売など回復を不安視されている業界も多い[^8]。
...
前述したように平行して開発者／ユーザイベントの準備にも追われたため作業は難航したが、なんとかイベント直前の4月3日にリニューアルオープンさせることができた。その後も、以下のような情報を追加していった。
...
コントリビュータが挑んでくれた未踏アドバンスト事業に落選したことで、いよいよ当法人は自らの力で開発資金を調達する必要に迫られた。
...
![図4 「Releases」のタグがつけられたコミット数を、プロダクトごとに集計した](./img/fig-4.png){ width=100% }

![図5 「Releases」のタグがつけられたコミット数を、作者ごとに集計した](./img/fig-5.png){ width=100% }

お断りしなければならないのは、これらのグラフで「今期の開発状況」全ては表現できていないということだ。たとえば、Vivliostyle Pubの開発が最も盛んだったのは3月〜6月だが、この当時はプライベートリポジトリだったこともあり（11月15日よりパブリックに移行[^14]）、「Releases」タグ自体を採用しておらず、このグラフにはまったく反映されていない。公式サイトのvivliostyle.org や同じくドキュメントページのvivliostyle_doc等、ドキュメント系のリポジトリも「Releases」タグを使っていないので同様だ。また、「Releases」タグがついてないからといって決して価値が低いコミットではないが、これらのグラフでは捨象されている。こうした問題はありつつも、Vivliostyle Pub以外のプロダクトのアクティブティを、ある程度客観的に把握することができると思う。
