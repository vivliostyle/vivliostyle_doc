...
2019年度、当法人は新たな開発体制を構築した。開発イベントを開催し、そこでコントリビュータになり得るエンジニアを集め、ついで月次で開発者会議を開催し、コントリビュータと開発方針を討議決定するといった体制である。そうした中で立ち上がってきたのが、以下のようなVivliostyle Pubの構想だった。

- 概要
    - ブラウザから操作するWebアプリ
    - クラウドにVivliostyle CLIをおき、ユーザのコンテンツはGitHubで管理する
    - ユーザはGitHubを意識する必要はないが、ログインのためにGitHubアカウントは用意してもらう
- ターゲットユーザ
