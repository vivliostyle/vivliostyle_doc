...
2020年度に入って早々の4月7日、東京、神奈川、埼玉、千葉、大阪、兵庫、福岡の7都府県に新型コロナウイルス感染拡大による緊急事態宣言が出された。前月から日経平均は滝のように急降下し、10年前のリーマンショックどころか、90年以上も前の世界恐慌に比する景気後退が懸念される局面になった[^2]（図1）[^3]。
...
![図1 2019年1月〜2020年6月の日経平均推移（提供：日本経済新聞社）](./img/fig-1.png)
...
こうして、コントリビュータが一丸となり、日に夜を継いでVivliostyle Pubの開発作業がはじまった。目指すのは5月中旬に予定されている2次審査だ。ここで高名な審査委員を前に、実際に動くVivliostyle Pubを披露しよう。以下はこうした作業の中で作られた、Vivliostyle Pubのフローチャート（図2）だ。

![図2 開発初期のVivliostyle Pubフローチャート（作図：@takanakahiko氏）](./img/fig-2.png)

開発と平行して難解な応募書類の作成に取り組み、4月2日に応募を完了。5月15日にはぶじに1次予選を通過する。翌16日、いよいよ村上代表理事を含むコントリビュータ達は2次審査に臨んだ。
