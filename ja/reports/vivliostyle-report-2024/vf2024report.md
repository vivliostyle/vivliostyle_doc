...
もう一つの今期のトピックスは、Vivliostyle Pubの再起動である。本プロダクトは2022年4月にアルファ版を公開した。当初はインストール不要で高水準なCSS組版を楽しめるWebアプリとして大方の好評を得た。ところが、時間の経過とともに気になる点が出てくるものだ。

たとえば、エンジニア好みのVScodeに似たインターフェイスは、「誰もが気軽に使える」はずのWebアプリと矛盾していないだろうか。また、アルファ版の公開後に大幅なアップデートを果たした新しいthemesが、本プロダクトでは使えないままである課題も解決できていないままだ。
