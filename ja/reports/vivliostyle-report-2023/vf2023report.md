...
一般社団法人ビブリオスタイル（以下、当法人）は、2018年4月1日に設立され、2023年3月31日までの5期間にわたり、法人活動を行ってまいりました。当法人は、オープンソースの電子書籍制作ツール「Vivliostyle」の開発・普及を目的としており、これまで多くの方々のご支援をいただきながら、活動を続けてまいりました。
...
![図3 経常収益の割合](./img/fig-3.svg){width=45%}

一つ一つ見ていこう。

前期の事業収益6,267,250円と、今期の事業収益3,235,750円の内訳をグラフにしてみた。

![図4 今期における事業収益の内訳](./img/fig-4.svg){ width=45% }



![図5 前期と今期における事業収益の内訳](./img/fig-5.svg){ width=70% }


![図6 支払手数料の内訳](./img/fig-6.svg){ width=70% }
