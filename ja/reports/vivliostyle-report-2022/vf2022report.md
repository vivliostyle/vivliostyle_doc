...
![図1 創立以来の貸借対照表における主な指標の変遷](./img/fig-1b.svg){ width=90% }
...
また、第1章では受託開発の売り上げが大幅に減少して赤字となった状況を説明したが、これは前期では受託開発に振り向けられていた村上代表理事の開発リソースが、今期はVivliostyle.jsをはじめとする前述プロダクトの開発に振り向けられた結果と見ることもできる。
